...
public class FilteringObjectsInRulesEngineTest {
...
//		try {
			...
			CompoundRulesKieSession  compoundRulesKieSession = (CompoundRulesKieSession) context.getBean("compoundRulesKieSession"); // try using different rule bases here.
			KieSession kSession = compoundRulesKieSession.getKieSession();
...
//	                return ((obj instanceof Calculation));
	                if(obj instanceof Calculation){
	                	...
	                	return tempCalculation.getResult() != 0;
	                }
	                return false;
	            }
	        });
