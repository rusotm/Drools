...
import org.rustom.shroff.calculatorFromScracth.compundRules.CompoundRules2KieSession;
import org.rustom.shroff.calculatorFromScracth.compundRules.CompoundRulesKieSession;
import org.springframework.beans.factory.BeanFactory;
import org.springframework.beans.factory.xml.XmlBeanFactory;
import org.springframework.core.io.FileSystemResource;

public class CompoundRule2Test {
...
//		try {
			...
			CompoundRules2KieSession  compoundRules2KieSession = (CompoundRules2KieSession) context.getBean("compoundRules2KieSession"); // try using different rule bases here.
			KieSession kSession = compoundRules2KieSession.getKieSession();
